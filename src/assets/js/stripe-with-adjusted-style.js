!function () {
  ...
  var l, h = /^(http(s)?):\/\//, f = function (e) {
      ...
      var r = t.protocol, i = t.host, n = t.pathname, o = t.hash, a = /:80$/, s = /:443$/;
    ...
    d = (m && m.origin, new Set(["https://checkout.stripe.com", "https://checkout.link.com", "https://buy.stripe.com", "https://book.stripe.com", "https://donate.stripe.com", "https://js.stripe.com"]), function (e, t) {
      var r = f(e), i = f(t);
      ...
      addEventListener: function (e, t, r, i) {
        ...
        e.removeEventListener(t, r, i), l = l.filter((function (n) {
          return function (e, t) {
            var r = u(e, 4), i = r[0], n = r[1], o = r[2], a = r[3], s = u(t, 4), c = s[0], l = s[1], h = s[2], f = s[3];
      ...
      !function (e, r) {
        ...
        }), Object.defineProperty(e, "prototype", {writable: !1}), r && t(e, r)
      }(a, n);
      ...
      return u = a, h = [{
        ...
        key: "createUniqueId", value: function () {
          return Math.random().toString(16).slice(2)
        }
      }, {
        key: "setIframeSrc", value: function () {
          var e = this.customerEmail ? encodeURIComponent(this.customerEmail) : void 0,
            ...
            r = "";
          r = "".concat(b, "pricing-table-app.html?").concat(t), this.frame.src = r
        }
      }, {
        key: "frameLoadListenerFunc", value: function () {
          this.messageIframe({
            id: "merchantUrl",
            lastLocation: I
          ...
          }), this.customerEmail && this.messageIframe({id: "customerEmail", value: this.customerEmail})
        }
      }, {
        key: "addFrameLoadListener", value: function () {
          this.frameLoadListener = this.frameLoadListenerFunc.bind(this), v(this.frame, "load", this.frameLoadListener, !1)
        }
      }, {
        key: "removeFrameLoadListener", value: function () {
          w(this.frame, "load", this.frameLoadListener, !1)
        }
      }, {
        key: "postMessageListenerFunc", value: function (e) {
          if (y(e.origin)) {
            var t = e.data;
            null !== t && "object" == typeof t && "iframeHeight" === t.id && t.uuid === this.uniqueId && "number" == typeof t.height && t.height && this.frame.height !== t.height && (this.frame.style.setProperty("height", "".concat(t.height, "px"), "important"), this.initialRenderedHeightSet || (this.messageIframe({id: "initialRenderedHeightSet"}), this.initialRenderedHeightSet = !0))
          }
        }
      }, {
        key: "addPostMessageListener", value: function () {
          this.postMessageListener = this.postMessageListenerFunc.bind(this), v(window, "message", this.postMessageListener, !1)
        }
      }, {
        key: "removePostMessageListener", value: function () {
          w(window, "message", this.postMessageListener, !1)
        }
      }, {
        key: "attachShadowDom", value: function () {
          this.attachShadow({mode: "open"}).appendChild(this.frame)
        }
      }, {
        key: "reInitializeIframeFunc", value: function () {
          this.messageIframe({id: "merchantUrl", lastLocation: I}), this.messageIframe({id: "initialRenderedHeightSet"})
        }
      }, {
        key: "pageShowListenerFunc", value: function (e) {
          e.persisted && (v(this.frame, "load", this.reInitializeIframe, !1), this.frame.src = this.frame.src)
        }
      }, {
        key: "addPageShowListener", value: function () {
        ...
        key: "createIframeElement", value: function () {
          ...
          e.style.setProperty("transition", "height 0.01s linear", "important");
          e.setAttribute("scrolling", "no");

          return e;
        }
      }, {
        key: "messageIframe", value: function (e) {
          var t = p(b);
        ...
        key: "reloadIframe", value: function () {
          this.initialRenderedHeightSet = !1, this.setIframeSrc()
        }
      }, {
        key: "attributeChangedCallback", value: function (e, t, r) {
          switch (e) {
            case"client-reference-id":
              this.messageIframe({id: "clientReferenceId", value: r}), this.clientReferenceId = r;
              break;
            case"customer-session-client-secret":
              this.messageIframe({id: "clientSecret", value: r}), this.clientSecret = r;
              break;
            case"customer-email":
              this.messageIframe({id: "customerEmail", value: r}), this.customerEmail = r;
              break;
      ...
      }]) && e(u.prototype, l), h && e(u, h), Object.defineProperty(u, "prototype", {writable: !1}), a
    }(s(HTMLElement));
  void 0 === customElements.get("stripe-pricing-table") && customElements.define("stripe-pricing-table", L)
}();
//# sourceMappingURL=https://js.stripe.com/v3/sourcemaps/pricing-table-4b2e1554c282ea92c9ebd2d97835c09d.js.map
